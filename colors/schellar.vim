...
if &background == "light"
    ...
    let s:palette.shade0 = [244, "#080808"]
else
    let s:palette.fg = [249, "#bcbcb0"]
    let s:palette.bg = [8, "#282C34"]
    let s:palette.shade0 = [244, "#808080"]
end
...
call s:HL('Comment', s:palette.shade0, s:palette.bg, 'none')
"         *Comment   any comment
...
call s:HL('Error', s:palette.bg, s:palette.fg, 'bold')
